...
`err`: Estimates the error rates by "alternating between sample inference and error rate estimation until convergence".

`dada`: "Removes all sequencing errors to reveal the members of the sequenced community". This is a de-noising step that removes Illumina errors.
